function ret=update_F_tilde(F_tilde,F,RR_tilde,action,dt,t)
    ...
    % RR_tilde{1} : NxdxT matrix, where N is the number of agents and T is the number of time steps.
    ...
    for i=1:o % should be successive
        ...
        elseif i==2
            F_tilde{o-i+1}(:,:,t)= F(RR_tilde,action(:,:,t));
            % F_tilde{o-i+1}(:,:,t)= F(RR_tilde,action);
        else
